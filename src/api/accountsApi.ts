...
// Route note: the backend AccountsController declares @Controller('api/v1/
// accounts') while main.ts also applies setGlobalPrefix('api/v1'), so the
// actually served route is /api/v1/api/v1/accounts (the Swagger docs show the
